...
<div class="tab_scrapping" transition:fade>
    ...
    <div class="cont_loader" transition:fade>
        ...
        <Circle3 size="180" ballTopLeft="rgb(120, 224, 255)" ballTopRight="rgb(255, 127, 120)" ballBottomLeft="rgb(172, 255, 120)" ballBottomRight="rgb(255, 161, 120)" unit="px" duration="1.2s"></Circle3>
        {/if}
    </div>
        {#if $store_processing === "scrapping"}
